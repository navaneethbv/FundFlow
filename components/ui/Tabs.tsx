      ...
      {items.map((item) => (
        <Link
          ...
          className={cn(
            ...
            "-mb-px inline-flex min-h-11 items-center whitespace-nowrap border-b-2 px-4 py-2.5 text-sm font-semibold transition-colors duration-150 focus-visible:outline-2",
            item.active
